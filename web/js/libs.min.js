! function (t, e) {
    ...
    function l(t, e, n) {
        if (void 0 === n && 1 === t.nodeType) {
            var i = "data-" + e.replace(zt, "-$1").toLowerCase();
    ...
    function c(t, e, n, i) {
        if (jt(t)) {
            var r, s, o = pt.expando,
                ...
                l = a ? pt.cache : t,
                u = a ? t[o] : t[o] && o;
            if (u && l[u] && (i || l[u].data) || void 0 !== n || "string" != typeof e) return u || (u = a ? t[o] = nt.pop() || pt.guid++ : o), l[u] || (l[u] = a ? {} : {
                toJSON: pt.noop
            }), "object" != typeof e && "function" != typeof e || (i ? l[u] = pt.extend(l[u], e) : l[u].data = pt.extend(l[u].data, e)), s = l[u], i || (s.data || (s.data = {}), s = s.data), void 0 !== n && (s[pt.camelCase(e)] = n), "string" == typeof e ? (r = s[e], null == r && (r = s[pt.camelCase(e)])) : r = s, r
        }
    }
    ...
    function h(t, e, n) {
        if (jt(t)) {
            ...
            if (o[a]) {
                ...
                }(n || (delete o[a].data, u(o[a]))) && (s ? pt.cleanData([t], !0) : ht.deleteExpando || o != o.window ? delete o[a] : o[a] = void 0)
            }
        }
    }
    ...
    function d(t, e, n, i) {
        ...
        if (c && c[3] !== u) {
            u = u || c[3], n = n || [], c = +l || 1;
            do s = s || ".5", c /= s, pt.style(t, e, c + u); while (s !== (s = a() / l) && 1 !== s && --o)
        }
    ...
    function f(t, e) {
        ...
        if (!s)
            for (s = [], n = t.childNodes || t; null != (i = n[r]); r++) !e || pt.nodeName(i, e) ? s.push(i) : pt.merge(s, f(i, e));
    ...
    function v(t, e, n, i, r) {
        for (var s, o, a, l, u, c, h, d = t.length, v = p(e), y = [], x = 0; x < d; x++)
            if (o = t[x], o || 0 === o)
                if ("object" === pt.type(o)) pt.merge(y, o.nodeType ? [o] : o);
                else if (Vt.test(o)) {
            for (l = l || v.appendChild(e.createElement("div")), u = (Ot.exec(o) || ["", ""])[1].toLowerCase(), h = Xt[u] || Xt._default, l.innerHTML = h[1] + pt.htmlPrefilter(o) + h[2], s = h[0]; s--;) l = l.lastChild;
            if (!ht.leadingWhitespace && Bt.test(o) && y.push(e.createTextNode(Bt.exec(o)[0])), !ht.tbody)
                for (o = "table" !== u || Ut.test(o) ? "<table>" !== h[1] || Ut.test(o) ? 0 : l : l.firstChild, s = o && o.childNodes.length; s--;) pt.nodeName(c = o.childNodes[s], "tbody") && !c.childNodes.length && o.removeChild(c);
            for (pt.merge(y, l.childNodes), l.textContent = ""; l.firstChild;) l.removeChild(l.firstChild);
            l = v.lastChild
        } else y.push(e.createTextNode(o));
        for (l && v.removeChild(l), ht.appendChecked || pt.grep(f(y, "input"), m), x = 0; o = y[x++];)
            if (i && pt.inArray(o, i) > -1) r && r.push(o);
            else if (a = pt.contains(o.ownerDocument, o), l = f(v.appendChild(o), "script"), a && g(l), n)
    ...
    function k(t, e) {
        ...
        if (1 === e.nodeType) {
            ...
            "script" === n && e.text !== t.text ? (C(e).text = t.text, T(e)) : "object" === n ? (e.parentNode && (e.outerHTML = t.outerHTML), ht.html5Clone && t.innerHTML && !pt.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === n && Ft.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === n ? e.defaultSelected = e.selected = t.defaultSelected : "input" !== n && "textarea" !== n || (e.defaultValue = t.defaultValue)
        }
    }
    ...
    function S(t, e, n, i) {
        ...
        var r, s, o, a, l, u, c = 0,
            ...
            p = e[0],
            g = pt.isFunction(p);
        if (g || h > 1 && "string" == typeof p && !ht.checkClone && ie.test(p)) return t.each(function (r) {
            var s = t.eq(r);
            g && (e[0] = p.call(this, r, s.html())), S(s, e, n, i)
        });
        if (h && (u = v(e, t[0].ownerDocument, !1, t, i), r = u.firstChild, 1 === u.childNodes.length && (u = r), r || i)) {
            for (a = pt.map(f(u, "script"), C), o = a.length; c < h; c++) s = u, c !== d && (s = pt.clone(s, !0, !0), o && pt.merge(a, f(s, "script"))), n.call(t[c], s, c);
            if (o)
                for (l = a[a.length - 1].ownerDocument, pt.map(a, T), c = 0; c < o; c++) s = a[c], It.test(s.type || "") && !pt._data(s, "globalEval") && pt.contains(l, s) && (s.src ? pt._evalUrl && pt._evalUrl(s.src) : pt.globalEval((s.text || s.textContent || s.innerHTML || "").replace(se, "")));
            u = r = null
        }
        return t
    }
    ...
    function N(t, e, n) {
        for (var i, r = e ? pt.filter(e, t) : t, s = 0; null != (i = r[s]); s++) n || 1 !== i.nodeType || pt.cleanData(f(i)), i.parentNode && (n && pt.contains(i.ownerDocument, i) && g(f(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    ...
    function D(t) {
        var e = it,
            n = ue[t];
        return n || (n = A(t, e), "none" !== n && n || (le = (le || pt("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = (le[0].contentWindow || le[0].contentDocument).document, e.write(), e.close(), n = A(t, e), le.detach()), ue[t] = n), n
    }
    ...
    function j(t) {
        ...
        for (var e = t.charAt(0).toUpperCase() + t.slice(1), n = Ce.length; n--;)
            if (t = Ce[n] + e, t in Te) return t
    }

    function $(t, e) {
        for (var n, i, r, s = [], o = 0, a = t.length; o < a; o++) i = t[o], i.style && (s[o] = pt._data(i, "olddisplay"), n = i.style.display, e ? (s[o] || "none" !== n || (i.style.display = ""), "" === i.style.display && Rt(i) && (s[o] = pt._data(i, "olddisplay", D(i.nodeName)))) : (r = Rt(i), (n && "none" !== n || !r) && pt._data(i, "olddisplay", r ? n : pt.css(i, "display"))));
    ...
    function q(t, e, n, i, r) {
        for (var s = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, o = 0; s < 4; s += 2) "margin" === n && (o += pt.css(t, n + Mt[s], !0, r)), i ? ("content" === n && (o -= pt.css(t, "padding" + Mt[s], !0, r)), "margin" !== n && (o -= pt.css(t, "border" + Mt[s] + "Width", !0, r))) : (o += pt.css(t, "padding" + Mt[s], !0, r), "padding" !== n && (o += pt.css(t, "border" + Mt[s] + "Width", !0, r)));
        return o
    }
    ...
    function H(t, e, n) {
        var i = !0,
            ...
            s = fe(t),
            o = ht.boxSizing && "border-box" === pt.css(t, "boxSizing", !1, s);
        if (r <= 0 || null == r) {
            if (r = ge(t, e, s), (r < 0 || null == r) && (r = t.style[e]), he.test(r)) return r;
            i = o && (ht.boxSizingReliable() || r === t.style[e]), r = parseFloat(r) || 0
        }
        return r + q(t, e, n || (o ? "border" : "content"), i, s) + "px"
    }
    ...
    function F(t, e, n) {
        for (var i, r = (B.tweeners[e] || []).concat(B.tweeners["*"]), s = 0, o = r.length; s < o; s++)
    ...
    function O(t, e, n) {
        ...
        if (pt.isEmptyObject(d)) "inline" === ("none" === u ? D(t.nodeName) : u) && (p.display = u);
        else {
            g ? "hidden" in g && (f = g.hidden) : g = pt._data(t, "fxshow", {}), s && (g.hidden = !f), f ? pt(t).show() : h.done(function () {
                pt(t).hide()
            }), h.done(function () {
                var e;
            ...
            for (i in d) o = F(f ? g[i] : 0, i, h), i in g || (g[i] = o.start, f && (o.end = o.start, o.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    function B(t, e, n) {
        var i, r, s = 0,
            ...
            l = function () {
                if (r) return !1;
                for (var e = Ee || R(), n = Math.max(0, u.startTime + u.duration - e), i = n / u.duration || 0, s = 1 - i, o = 0, l = u.tweens.length; o < l; o++) u.tweens[o].run(s);
        ...
        for (I(c, u.opts.specialEasing); s < o; s++)
            if (i = B.prefilters[s].call(u, t, c, u.opts)) return pt.isFunction(i.stop) && (pt._queueHooks(u.elem, u.opts.queue).stop = pt.proxy(i.stop, i)), i;
        return pt.map(c, F, u), pt.isFunction(u.opts.start) && u.opts.start.call(t, u), pt.fx.timer(pt.extend(l, {
            elem: t,
            anim: u,
            queue: u.opts.queue
    ...
    pt.fn = pt.prototype = {
        ...
        for ("boolean" == typeof o && (u = o, o = arguments[a] || {}, a++), "object" == typeof o || pt.isFunction(o) || (o = {}), a === l && (o = this, a--); a < l; a++)
            if (null != (r = arguments[a]))
                for (i in r) t = o[i], n = r[i], o !== n && (u && n && (pt.isPlainObject(n) || (e = pt.isArray(n))) ? (e ? (e = !1, s = t && pt.isArray(t) ? t : []) : s = t && pt.isPlainObject(t) ? t : {}, o[i] = pt.extend(u, s, n)) : void 0 !== n && (o[i] = n));
        return o
    }, pt.extend({
    ...
    var yt = function (t) {
        function e(t, e, n, i) {
            var r, s, o, a, l, u, h, p, f = e && e.ownerDocument,
                g = e ? e.nodeType : 9;
            if (n = n || [], "string" != typeof t || !t || 1 !== g && 9 !== g && 11 !== g) return n;
            if (!i && ((e ? e.ownerDocument || e : F) !== j && L(e), e = e || j, z)) {
                if (11 !== g && (u = vt.exec(t)))
                    if (r = u[1]) {
                        if (9 === g) {
                ...
                if (w.qsa && !X[t + " "] && (!q || !q.test(t))) {
                    if (1 !== g) f = e, p = t;
                    else if ("object" !== e.nodeName.toLowerCase()) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(xt, "\\$&") : e.setAttribute("id", a = P), h = E(t), s = h.length, l = dt.test(a) ? "#" + a : "[id='" + a + "']"; s--;) h[s] = l + " " + d(h[s]);
                        p = h.join(","), f = yt.test(t) && c(e.parentNode) || e
                    }
                    if (p) try {
        ...
        function p(t, e, n) {
            ...
            return e.first ? function (e, n, s) {
                ...
                if (o) {
                    ...
                    for (; e = e[i];)
                        if (1 === e.nodeType || r) {
                            if (u = e[P] || (e[P] = {}), l = u[e.uniqueID] || (u[e.uniqueID] = {}), (a = l[i]) && a[0] === O && a[1] === s) return c[2] = a[2];
        ...
        function v(t, e, n, r, s, o) {
            return r && !r[P] && (r = v(r)), s && !s[P] && (s = v(s, o)), i(function (i, o, a, l) {
                var u, c, h, d = [],
                    p = [],
                    f = o.length,
                    ...
                    x = n ? s || (i ? t : f || r) ? [] : o : y;
                if (n && n(y, x, a, l), r)
                    for (u = m(x, p), r(u, [], a, l), c = u.length; c--;)(h = u[c]) && (x[p[c]] = !(y[p[c]] = h));
                if (i) {
                    if (s || t) {
                        if (s) {
                        ...
                        for (c = x.length; c--;)(h = x[c]) && (u = s ? tt(i, h) : d[c]) > -1 && (i[u] = !(o[u] = h))
                    }
                } else x = m(x === o ? x.splice(f, x.length) : x), s ? s(null, o, x, l) : J.apply(o, x)
            })
        }

        function y(t) {
            for (var e, n, i, r = t.length, s = _.relative[t[0].type], o = s || _.relative[" "], a = s ? 1 : 0, l = p(function (t) {
                    return t === e
                }, o, !0), u = p(function (t) {
                    return tt(e, t) > -1
                }, o, !0), c = [function (t, n, i) {
                    var r = !s && (i || n !== N) || ((e = n).nodeType ? l(t, n, i) : u(t, n, i));
                    return e = null, r
                }]; a < r; a++)
                if (n = _.relative[t[a].type]) c = [p(f(c), n)];
                else {
            ...
            var r = n.length > 0,
                ...
                o = function (i, o, a, l, u) {
                    var c, h, d, p = 0,
                        ...
                        w = x.length;
                    for (u && (N = o === j || o || u); f !== w && null != (c = x[f]); f++) {
                        if (s && c) {
                            for (h = 0, o || c.ownerDocument === j || (L(c), a = !z); d = t[h++];)
                                if (d(c, o || j, a)) {
                                    l.push(c);
                                    break
                                }
        ...
        var b, w, _, C, T, E, k, S, N, A, D, L, j, $, z, q, H, M, R, P = "sizzle" + 1 * new Date,
            F = t.document,
            O = 0,
            I = 0,
            B = n(),
        ...
        try {
            J.apply(Z = K.call(F.childNodes), F.childNodes), Z[F.childNodes.length].nodeType
        } catch (Ct) {
            J = {
        ...
        w = e.support = {}, T = e.isXML = function (t) {
            ...
            return i !== j && 9 === i.nodeType && i.documentElement ? (j = i, $ = j.documentElement, z = !T(j), (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", _t, !1) : n.attachEvent && n.attachEvent("onunload", _t)), w.attributes = r(function (t) {
                return t.className = "i", !t.getAttribute("className")
            }), w.getElementsByTagName = r(function (t) {
                return t.appendChild(j.createComment("")), !t.getElementsByTagName("*").length
            }), w.getElementsByClassName = mt.test(j.getElementsByClassName), w.getById = r(function (t) {
            ...
            }, H = [], q = [], (w.qsa = mt.test(j.querySelectorAll)) && (r(function (t) {
            ...
            })), (w.matchesSelector = mt.test(M = $.matches || $.webkitMatchesSelector || $.mozMatchesSelector || $.oMatchesSelector || $.msMatchesSelector)) && r(function (t) {
                w.disconnectedMatch = M.call(t, "div"), M.call(t, "[s!='']:x"), H.push("!=", st)
            }), q = q.length && new RegExp(q.join("|")), H = H.length && new RegExp(H.join("|")), e = mt.test($.compareDocumentPosition), R = e || mt.test($.contains) ? function (t, e) {
                ...
                return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === j || t.ownerDocument === F && R(F, t) ? -1 : e === j || e.ownerDocument === F && R(F, e) ? 1 : A ? tt(A, t) - tt(A, e) : 0 : 4 & n ? -1 : 1)
            } : function (t, e) {
                if (t === e) return D = !0, 0;
                var n, i = 0,
                    r = t.parentNode,
                    ...
                    a = [t],
                    l = [e];
                if (!r || !s) return t === j ? -1 : e === j ? 1 : r ? -1 : s ? 1 : A ? tt(A, t) - tt(A, e) : 0;
                if (r === s) return o(t, e);
                for (n = t; n = n.parentNode;) a.unshift(n);
                for (n = e; n = n.parentNode;) l.unshift(n);
                for (; a[i] === l[i];) i++;
                return i ? o(a[i], l[i]) : a[i] === F ? -1 : l[i] === F ? 1 : 0
            }, j) : j
        }, e.matches = function (t, n) {
            return e(t, null, null, n)
        }, e.matchesSelector = function (t, n) {
            if ((t.ownerDocument || t) !== j && L(t), n = n.replace(ct, "='$1']"), w.matchesSelector && z && !X[n + " "] && (!H || !H.test(n)) && (!q || !q.test(n))) try {
                var i = M.call(t, n);
                if (i || w.disconnectedMatch || t.document && 11 !== t.document.nodeType) return i
            } catch (r) {}
            return e(n, j, null, [t]).length > 0
        }, e.contains = function (t, e) {
            return (t.ownerDocument || t) !== j && L(t), R(t, e)
        }, e.attr = function (t, e) {
            (t.ownerDocument || t) !== j && L(t);
            var n = _.attrHandle[e.toLowerCase()],
                i = n && Q.call(_.attrHandle, e.toLowerCase()) ? n(t, e, !z) : void 0;
            ...
            preFilter: {
                ...
                PSEUDO: function (t) {
                    var e, n = !t[6] && t[2];
                    return pt.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && ht.test(n) && (e = E(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                }
            },
            filter: {
                TAG: function (t) {
                    ...
                    return 1 === i && 0 === r ? function (t) {
                        ...
                        if (m) {
                            ...
                            if (f = [o ? m.firstChild : m.lastChild], o && y) {
                                for (d = m, h = d[P] || (d[P] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), u = c[t] || [], p = u[0] === O && u[1], x = p && u[2],
                                    d = p && m.childNodes[p]; d = ++p && d && d[g] || (x = p = 0) || f.pop();)
                                    if (1 === d.nodeType && ++x && d === e) {
                                        c[t] = [O, p, x];
                                        break
                                    }
                            } else if (y && (d = e, h = d[P] || (d[P] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), u = c[t] || [], p = u[0] === O && u[1], x = p), x === !1)
                                for (;
                                    (d = ++p && d && d[g] || (x = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++x || (y && (h = d[P] || (d[P] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), c[t] = [O, x]), d !== e)););
                ...
                PSEUDO: function (t, n) {
                    ...
                    return s[P] ? s(n) : s.length > 1 ? (r = [t, t, "", n], _.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function (t, e) {
                ...
                lang: i(function (t) {
                    return dt.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(bt, wt).toLowerCase(),
                        function (e) {
                            var n;
                            do
                                if (n = z ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang")) return n = n.toLowerCase(), n === t || 0 === n.indexOf(t + "-"); while ((e = e.parentNode) && 1 === e.nodeType);
                            return !1
                        }
                }),
                target: function (e) {
        ...
        return h.prototype = _.filters = _.pseudos, _.setFilters = new h, E = e.tokenize = function (t, n) {
            ...
            for (a = t, l = [], u = _.preFilter; a;) {
                ...
                for (o in _.filter) !(r = pt[o].exec(a)) || u[o] && !(r = u[o](r)) || (i = r.shift(), s.push({
                    value: i,
                    type: o,
                    matches: r
                }), a = a.slice(i.length));
            ...
            var n, i = [],
                ...
                s = X[t + " "];
            if (!s) {
                for (e || (e = E(t)), n = e.length; n--;) s = y(e[n]), s[P] ? i.push(s) : r.push(s);
                s = X(t, x(r, i)), s.selector = t
            }
            return s
            ...
            if (n = n || [], 1 === h.length) {
                if (s = h[0] = h[0].slice(0), s.length > 2 && "ID" === (o = s[0]).type && w.getById && 9 === e.nodeType && z && _.relative[s[1].type]) {
                    if (e = (_.find.ID(o.matches[0].replace(bt, wt), e) || [])[0], !e) return n;
                    u && (e = e.parentNode), t = t.slice(s.shift().value.length)
                }
                for (r = pt.needsContext.test(t) ? 0 : s.length; r-- && (o = s[r], !_.relative[a = o.type]);)
                    if ((l = _.find[a]) && (i = l(o.matches[0].replace(bt, wt), yt.test(s[0].type) && c(e.parentNode) || e))) {
                        if (s.splice(r, 1), t = i.length && d(s), !t) return J.apply(n, i), n;
                        break
                    }
            }
            return (u || k(t, h))(i, e, !z, n, !e || yt.test(t) && c(e.parentNode) || e), n
        }, w.sortStable = P.split("").sort(V).join("") === P, w.detectDuplicates = !!D, L(), w.sortDetached = r(function (t) {
    ...
    var Tt, Et = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
        kt = pt.fn.init = function (t, e, n) {
            ...
            if (n = n || Tt, "string" == typeof t) {
                ...
                if (i[1]) {
                    if (e = e instanceof pt ? e[0] : e, pt.merge(this, pt.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : it, !0)), _t.test(i[1]) && pt.isPlainObject(e))
    ...
    pt.fn.extend({
        ...
        closest: function (t, e) {
            for (var n, i = 0, r = this.length, s = [], o = wt.test(t) || "string" != typeof t ? pt(t, e || this.context) : 0; i < r; i++)
        ...
        pt.fn[t] = function (n, i) {
            ...
            return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (r = pt.filter(i, r)), this.length > 1 && (Nt[t] || (r = pt.uniqueSort(r)), St.test(t) && (r = r.reverse())), this.pushStack(r)
        }
    });
    var At = /\S+/g;
    pt.Callbacks = function (t) {
        ...
        var e, n, i, r, o = [],
            ...
            c = {
                add: function () {
                    return o && (n && !e && (l = o.length - 1, a.push(n)), function i(e) {
        ...
        Deferred: function (t) {
            var e = [["resolve", "done", pt.Callbacks("once memory"), "resolved"], ["reject", "fail", pt.Callbacks("once memory"), "rejected"], ["notify", "progress", pt.Callbacks("memory")]],
                        ...
                        return pt.Deferred(function (n) {
                            pt.each(e, function (e, s) {
                                ...
                                r[s[1]](function () {
                                    ...
                                    t && pt.isFunction(t.promise) ? t.promise().progress(n.notify).done(n.resolve).fail(n.reject) : n[s[0] + "With"](this === i ? n.promise() : this, o ? [t] : arguments)
                                })
                            }), t = null
                        }).promise()
                    },
                ...
                r = {};
            return i.pipe = i.then, pt.each(e, function (t, s) {
                var o = s[2],
                    a = s[3];
        ...
        when: function (t) {
            ...
            if (o > 1)
                for (e = new Array(o), n = new Array(o), i = new Array(o); r < o; r++) s[r] && pt.isFunction(s[r].promise) ? s[r].promise().progress(u(r, n, e)).done(u(r, i, s)).fail(l.reject) : --a;
    ...
    var Lt;
    for (Lt in pt(ht)) break;
    ht.ownFirst = "0" === Lt, ht.inlineBlockNeedsLayout = !1, pt(function () {
            var t, e, n, i;
    ...
    pt.extend({
            ...
            data: function (t, e) {
                ...
                if (void 0 === t) {
                    if (this.length && (r = pt.data(s), 1 === s.nodeType && !pt._data(s, "parsedAttrs"))) {
                        for (n = o.length; n--;) o[n] && (i = o[n].name, 0 === i.indexOf("data-") && (i = pt.camelCase(i.slice(5)), l(s, i, r[i])));
            ...
            promise: function (t, e) {
                ...
                for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; o--;) n = pt._data(s[o], t + "queueHooks"), n && n.empty && (i++, n.empty.add(a));
    ...
    var qt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        Pt = function (t, e, n, i, r, s, o) {
            ...
            } else if (void 0 !== i && (r = !0, pt.isFunction(i) || (o = !0), u && (o ? (e.call(t, i), e = null) : (u = e, e = function (t, e, n) {
    ...
    pt.event = {
        ...
        add: function (t, e, n, i, r) {
            var s, o, a, l, u, c, h, d, p, f, g, m = pt._data(t);
            if (m) {
                for (n.handler && (l = n, n = l.handler, r = l.selector), n.guid || (n.guid = pt.guid++), (o = m.events) || (o = m.events = {}), (c = m.handle) || (c = m.handle = function (t) {
                        return "undefined" == typeof pt || t && pt.event.triggered === t.type ? void 0 : pt.event.dispatch.apply(c.elem, arguments)
                    }, c.elem = t), e = (e || "").match(At) || [""], a = e.length; a--;) s = Jt.exec(e[a]) || [], p = g = s[1], f = (s[2] || "").split(".").sort(), p && (u = pt.event.special[p] || {}, p = (r ? u.delegateType : u.bindType) || p, u = pt.event.special[p] || {}, h = pt.extend({
                    type: p,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, l), (d = o[p]) || (d = o[p] = [], d.delegateCount = 0, u.setup && u.setup.call(t, i, f, c) !== !1 || (t.addEventListener ? t.addEventListener(p, c, !1) : t.attachEvent && t.attachEvent("on" + p, c))), u.add && (u.add.call(t, h), h.handler.guid || (h.handler.guid = n.guid)), r ? d.splice(d.delegateCount++, 0, h) : d.push(h), pt.event.global[p] = !0);
                t = null
            }
        },
        remove: function (t, e, n, i, r) {
            var s, o, a, l, u, c, h, d, p, f, g, m = pt.hasData(t) && pt._data(t);
            if (m && (c = m.events)) {
                for (e = (e || "").match(At) || [""], u = e.length; u--;)
                    if (a = Jt.exec(e[u]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p) {
                        for (h = pt.event.special[p] || {}, p = (i ? h.delegateType : h.bindType) || p, d = c[p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = s = d.length; s--;) o = d[s], !r && g !== o.origType || n && n.guid !== o.guid || a && !a.test(o.namespace) || i && i !== o.selector && ("**" !== i || !o.selector) || (d.splice(s, 1), o.selector && d.delegateCount--, h.remove && h.remove.call(t, o));
                        l && !d.length && (h.teardown && h.teardown.call(t, f, m.handle) !== !1 || pt.removeEvent(t, p, m.handle), delete c[p])
                    } else
        ...
        trigger: function (e, n, i, r) {
            var s, o, a, l, u, c, h, d = [i || it],
                p = ct.call(e, "type") ? e.type : e,
                f = ct.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = c = i = i || it, 3 !== i.nodeType && 8 !== i.nodeType && !Gt.test(p + pt.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), o = p.indexOf(":") < 0 && "on" + p, e = e[pt.expando] ? e : new pt.Event(p, "object" == typeof e && e), e.isTrigger = r ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : pt.makeArray(n, [e]), u = pt.event.special[p] || {}, r || !u.trigger || u.trigger.apply(i, n) !== !1)) {
                if (!r && !u.noBubble && !pt.isWindow(i)) {
                    for (l = u.delegateType || p, Gt.test(l + p) || (a = a.parentNode); a; a = a.parentNode) d.push(a), c = a;
                    c === (i.ownerDocument || it) && d.push(c.defaultView || c.parentWindow || t)
                }
                for (h = 0;
                    (a = d[h++]) && !e.isPropagationStopped();) e.type = h > 1 ? l : u.bindType || p, s = (pt._data(a, "events") || {})[e.type] && pt._data(a, "handle"), s && s.apply(a, n), s = o && a[o], s && s.apply && jt(a) && (e.result = s.apply(a, n), e.result === !1 && e.preventDefault());
                if (e.type = p, !r && !e.isDefaultPrevented() && (!u._default || u._default.apply(d.pop(), n) === !1) && jt(i) && o && i[p] && !pt.isWindow(i)) {
            ...
            if (a[0] = t, t.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, t) !== !1) {
                for (o = pt.event.handlers.call(this, t, l), e = 0;
                    ...
                    for (t.currentTarget = r.elem, n = 0;
                        (s = r.handlers[n++]) && !t.isImmediatePropagationStopped();) t.rnamespace && !t.rnamespace.test(s.namespace) || (t.handleObj = s, t.data = s.data, i = ((pt.event.special[s.origType] || {}).handle || s.handler).apply(r.elem, a), void 0 !== i && (t.result = i) === !1 && (t.preventDefault(), t.stopPropagation()));
            ...
            if (a && l.nodeType && ("click" !== t.type || isNaN(t.button) || t.button < 1))
                for (; l != this; l = l.parentNode || this)
                    if (1 === l.nodeType && (l.disabled !== !0 || "click" !== t.type)) {
                        for (i = [], n = 0; n < a; n++) s = e[n], r = s.selector + " ", void 0 === i[r] && (i[r] = s.needsContext ? pt(r, this).index(l) > -1 : pt.find(r, this, null, [l]).length), i[r] && i.push(s);
                        i.length && o.push({
                            elem: l,
                            handlers: i
                        })
        ...
        fix: function (t) {
            ...
            var e, n, i, r = t.type,
                s = t,
                o = this.fixHooks[r];
            for (o || (this.fixHooks[r] = o = Yt.test(r) ? this.mouseHooks : Zt.test(r) ? this.keyHooks : {}), i = o.props ? this.props.concat(o.props) : this.props, t = new pt.Event(s), e = i.length; e--;) n = i[e], t[n] = s[n];
        ...
        return this instanceof pt.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && t.returnValue === !1 ? y : x) : this.type = t, e && pt.extend(this, e), this.timeStamp = t && t.timeStamp || pt.now(), void(this[pt.expando] = !0)) : new pt.Event(t, e)
    }, pt.Event.prototype = {
    ...
    pt.extend({
        ...
        clone: function (t, e, n) {
            var i, r, s, o, a, l = pt.contains(t.ownerDocument, t);
            if (ht.html5Clone || pt.isXMLDoc(t) || !te.test("<" + t.nodeName + ">") ? s = t.cloneNode(!0) : (ae.innerHTML = t.outerHTML, ae.removeChild(s = ae.firstChild)), !(ht.noCloneEvent && ht.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || pt.isXMLDoc(t)))
                for (i = f(s), a = f(t), o = 0; null != (r = a[o]); ++o) i[o] && k(r, i[o]);
            if (e)
                if (n)
                    for (a = a || f(t), i = i || f(s), o = 0; null != (r = a[o]); o++) E(r, i[o]);
                else E(t, s);
            return i = f(s, "script"), i.length > 0 && g(i, !l && f(t, "script")), i = a = r = null, s
        },
        cleanData: function (t, e) {
            for (var n, i, r, s, o = 0, a = pt.expando, l = pt.cache, u = ht.attributes, c = pt.event.special; null != (n = t[o]); o++)
                if ((e || jt(n)) && (r = n[a], s = r && l[r])) {
                    if (s.events)
                        for (i in s.events) c[i] ? pt.event.remove(n, i) : pt.removeEvent(n, i, s.handle);
        ...
        html: function (t) {
            return Pt(this, function (t) {
                ...
                if ("string" == typeof t && !ne.test(t) && (ht.htmlSerialize || !te.test(t)) && (ht.leadingWhitespace || !Bt.test(t)) && !Xt[(Ot.exec(t) || ["", ""])[1].toLowerCase()]) {
        ...
        pt.fn[t] = function (t) {
            for (var n, i = 0, r = [], s = pt(t), o = s.length - 1; i <= o; i++) n = i === o ? this : this.clone(!0), pt(s[i])[e](n), ot.apply(r, n.get());
    ...
    ! function () {
        function e() {
            ...
            h.appendChild(l), u.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", n = r = a = !1, i = o = !0, t.getComputedStyle && (c = t.getComputedStyle(u), n = "1%" !== (c || {}).top, a = "2px" === (c || {}).marginLeft, r = "4px" === (c || {
                width: "4px"
    ...
    t.getComputedStyle ? (fe = function (e) {
        ...
        return n = n || fe(t), o = n ? n.getPropertyValue(e) || n[e] : void 0, "" !== o && void 0 !== o || pt.contains(t.ownerDocument, t) || (o = pt.style(t, e)), n && !ht.pixelMarginRight() && he.test(o) && ce.test(e) && (i = a.width, r = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = o, o = n.width, a.width = i, a.minWidth = r, a.maxWidth = s), void 0 === o ? o : o + ""
    }) : pe.currentStyle && (fe = function (t) {
        return t.currentStyle
    }, ge = function (t, e, n) {
        var i, r, s, o, a = t.style;
        return n = n || fe(t), o = n ? n[e] : void 0, null == o && a && a[e] && (o = a[e]), he.test(o) && !me.test(e) && (i = a.left, r = t.runtimeStyle, s = r && r.left, s && (r.left = t.currentStyle.left), a.left = "fontSize" === e ? "1em" : o, o = a.pixelLeft + "px", a.left = i, s && (r.left = s)), void 0 === o ? o : o + "" || "auto"
    });
    var ve = /alpha\([^)]*\)/i,
        ye = /opacity\s*=\s*([^)]*)/i,
        xe = /^(none|table(?!-c[ea]).+)/,
    ...
    pt.extend({
        ...
        style: function (t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var r, s, o, a = pt.camelCase(e),
                    l = t.style;
                if (e = pt.cssProps[a] || (pt.cssProps[a] = j(a) || a), o = pt.cssHooks[e] || pt.cssHooks[a], void 0 === n) return o && "get" in o && void 0 !== (r = o.get(t, !1, i)) ? r : l[e];
                if (s = typeof n, "string" === s && (r = Ht.exec(n)) && r[1] && (n = d(t, e, r), s = "number"), null != n && n === n && ("number" === s && (n += r && r[3] || (pt.cssNumber[a] ? "" : "px")), ht.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(o && "set" in o && void 0 === (n = o.set(t, n, i))))) try {
                    l[e] = n
                } catch (u) {}
            }
        },
        css: function (t, e, n, i) {
            var r, s, o, a = pt.camelCase(e);
            return e = pt.cssProps[a] || (pt.cssProps[a] = j(a) || a), o = pt.cssHooks[e] || pt.cssHooks[a], o && "get" in o && (s = o.get(t, !0, n)), void 0 === s && (s = ge(t, e, i)), "normal" === s && e in _e && (s = _e[e]), "" === n || n ? (r = parseFloat(s), n === !0 || isFinite(r) ? r || 0 : s) : s
        }
    }), pt.each(["height", "width"], function (t, e) {
        pt.cssHooks[e] = {
            get: function (t, n, i) {
                if (n) return xe.test(pt.css(t, "display")) && 0 === t.offsetWidth ? de(t, we, function () {
                    return H(t, e, i)
                }) : H(t, e, i)
            },
            set: function (t, n, i) {
                var r = i && fe(t);
                return z(t, n, i ? q(t, e, i, ht.boxSizing && "border-box" === pt.css(t, "boxSizing", !1, r), r) : 0)
            }
        }
        ...
        set: function (t, e) {
            ...
            n.zoom = 1, (e >= 1 || "" === e) && "" === pt.trim(s.replace(ve, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === e || i && !i.filter) || (n.filter = ve.test(s) ? s.replace(ve, r) : s + " " + r)
        }
    }), pt.cssHooks.marginRight = L(ht.reliableMarginRight, function (t, e) {
        if (e) return de(t, {
            display: "inline-block"
        }, ge, [t, "marginRight"])
    }), pt.cssHooks.marginLeft = L(ht.reliableMarginLeft, function (t, e) {
        if (e) return (parseFloat(ge(t, "marginLeft")) || (pt.contains(t.ownerDocument, t) ? t.getBoundingClientRect().left - de(t, {
            marginLeft: 0
        }, function () {
        ...
        pt.cssHooks[t + e] = {
            expand: function (n) {
                for (var i = 0, r = {}, s = "string" == typeof n ? n.split(" ") : [n]; i < 4; i++) r[t + Mt[i] + e] = s[i] || s[i - 2] || s[0];
                return r
            }
        ...
        css: function (t, e) {
            return Pt(this, function (t, e, n) {
                var i, r, s = {},
                    o = 0;
                if (pt.isArray(e)) {
                    for (i = fe(t), r = e.length; o < r; o++) s[e[o]] = pt.css(t, e[o], !1, i);
                    return s
                }
    ...
    pt.Animation = pt.extend(B, {
            ...
            stop: function (t, e, n) {
                ...
                return "string" != typeof t && (n = e, e = t, t = void 0), e && t !== !1 && this.queue(t || "fx", []), this.each(function () {
                    ...
                    if (r) o[r] && o[r].stop && i(o[r]);
                        ...
                        for (r in o) o[r] && o[r].stop && Ne.test(r) && i(o[r]);
            ...
            var t, e = pt.timers,
                n = 0;
            for (Ee = pt.now(); n < e.length; n++) t = e[n], t() || e[n] !== t || e.splice(n--, 1);
    ...
    pt.fn.extend({
        val: function (t) {
            var e, n, i, r = this[0]; {
                ...
                if (r) return e = pt.valHooks[r.type] || pt.valHooks[r.nodeName.toLowerCase()], e && "get" in e && void 0 !== (n = e.get(r, "value")) ? n : (n = r.value, "string" == typeof n ? n.replace(Ae, "") : null == n ? "" : n)
            }
        }
    }), pt.extend({
        valHooks: {
            ...
            select: {
                get: function (t) {
                    for (var e, n, i = t.options, r = t.selectedIndex, s = "select-one" === t.type || r < 0, o = s ? null : [], a = s ? r + 1 : i.length, l = r < 0 ? a : s ? r : 0; l < a; l++)
                        if (n = i[l], (n.selected || l === r) && (ht.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !pt.nodeName(n.parentNode, "optgroup"))) {
                ...
                set: function (t, e) {
                    for (var n, i, r = t.options, s = pt.makeArray(e), o = r.length; o--;)
                        if (i = r[o], pt.inArray(pt.valHooks.option.get(i), s) > -1) try {
                            i.selected = n = !0
                        } catch (a) {
                            i.scrollHeight
                        } else i.selected = !1;
    ...
    var Le, je, $e = pt.expr.attrHandle,
        ze = /^(?:checked|selected)$/i,
        qe = ht.getSetAttribute,
        He = ht.input;
    pt.fn.extend({
        attr: function (t, e) {
        ...
        attr: function (t, e, n) {
            var i, r, s = t.nodeType;
            if (3 !== s && 8 !== s && 2 !== s) return "undefined" == typeof t.getAttribute ? pt.prop(t, e, n) : (1 === s && pt.isXMLDoc(t) || (e = e.toLowerCase(), r = pt.attrHooks[e] || (pt.expr.match.bool.test(e) ? je : Le)), void 0 !== n ? null === n ? void pt.removeAttr(t, e) : r && "set" in r && void 0 !== (i = r.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : r && "get" in r && null !== (i = r.get(t, e)) ? i : (i = pt.find.attr(t, e), null == i ? void 0 : i))
        },
        attrHooks: {
            type: {
                set: function (t, e) {
        ...
        removeAttr: function (t, e) {
            var n, i, r = 0,
                s = e && e.match(At);
            if (s && 1 === t.nodeType)
                for (; n = s[r++];) i = pt.propFix[n] || n, pt.expr.match.bool.test(n) ? He && qe || !ze.test(n) ? t[i] = !1 : t[pt.camelCase("default-" + n)] = t[i] = !1 : pt.attr(t, n, ""), t.removeAttribute(qe ? n : i)
        }
    }), je = {
        set: function (t, e, n) {
            return e === !1 ? pt.removeAttr(t, n) : He && qe || !ze.test(n) ? t.setAttribute(!qe && pt.propFix[n] || n, n) : t[pt.camelCase("default-" + n)] = t[n] = !0, n
        }
    }, pt.each(pt.expr.match.bool.source.match(/\w+/g), function (t, e) {
        var n = $e[e] || pt.find.attr;
        He && qe || !ze.test(e) ? $e[e] = function (t, e, i) {
            var r, s;
            return i || (s = $e[e], $e[e] = r, r = null != n(t, e, i) ? e.toLowerCase() : null, $e[e] = s), r
        } : $e[e] = function (t, e, n) {
            if (!n) return t[pt.camelCase("default-" + e)] ? e.toLowerCase() : null
        }
    }), He && qe || (pt.attrHooks.value = {
        set: function (t, e, n) {
            return pt.nodeName(t, "input") ? void(t.defaultValue = e) : Le && Le.set(t, e, n)
        }
    }), qe || (Le = {
        set: function (t, e, n) {
        ...
        propHooks: {
            tabIndex: {
                get: function (t) {
                    ...
                    return e ? parseInt(e, 10) : Me.test(t.nodeName) || Re.test(t.nodeName) && t.href ? 0 : -1
                }
            }
        },
        propFix: {
    ...
    pt.fn.extend({
        addClass: function (t) {
            ...
            if ("string" == typeof t && t)
                for (e = t.match(At) || []; n = this[l++];)
                    if (r = W(n), i = 1 === n.nodeType && (" " + r + " ").replace(Pe, " ")) {
        ...
        toggleClass: function (t, e) {
            ...
            return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : pt.isFunction(t) ? this.each(function (n) {
                ...
                var e, i, r, s;
                if ("string" === n)
                    for (i = 0, r = pt(this), s = t.match(At) || []; e = s[i++];) r.hasClass(e) ? r.removeClass(e) : r.addClass(e);
    ...
    pt.parseJSON = function (e) {
        ...
        var n, i = null,
            r = pt.trim(e + "");
        return r && !pt.trim(r.replace(Be, function (t, e, r, s) {
    ...
    pt.extend({
        ...
        ajax: function (e, n) {
            function i(e, n, i, r) {
                var s, h, y, x, w, C = n;
                2 !== b && (b = 2, l && t.clearTimeout(l), c = void 0, a = r || "", _.readyState = e > 0 ? 4 : 0, s = e >= 200 && e < 300 || 304 === e, i && (x = Q(d, _, i)), x = Z(d, x, _, s), s ? (d.ifModified && (w = _.getResponseHeader("Last-Modified"), w && (pt.lastModified[o] = w), w = _.getResponseHeader("etag"), w && (pt.etag[o] = w)), 204 === e || "HEAD" === d.type ? C = "nocontent" : 304 === e ? C = "notmodified" : (C = x.state, h = x.data, y = x.error, s = !y)) : (y = C, !e && C || (C = "error", e < 0 && (e = 0))), _.status = e, _.statusText = (n || C) + "", s ? g.resolveWith(p, [h, C, _]) : g.rejectWith(p, [_, C, y]), _.statusCode(v), v = void 0, u && f.trigger(s ? "ajaxSuccess" : "ajaxError", [_, d, s ? h : y]), m.fireWith(p, [_, C]), u && (f.trigger("ajaxComplete", [_, d]), --pt.active || pt.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (n = e, e = void 0), n = n || {};
            var r, s, o, a, l, u, c, h, d = pt.ajaxSetup({}, n),
                p = d.context || d,
                ...
                _ = {
                    ...
                    getResponseHeader: function (t) {
                        ...
                        if (2 === b) {
                            if (!h)
                                for (h = {}; e = Ve.exec(a);) h[e[1].toLowerCase()] = e[2];
                            e = h[t.toLowerCase()]
                        }
            ...
            if (g.promise(_).complete = m.add, _.success = _.done, _.error = _.fail, d.url = ((e || d.url || tn) + "").replace(We, "").replace(Ze, en[1] + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = pt.trim(d.dataType || "*").toLowerCase().match(At) || [""], null == d.crossDomain && (r = Ye.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === en[1] && r[2] === en[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (en[3] || ("http:" === en[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = pt.param(d.data, d.traditional)), V(Ge, d, n, _), 2 === b) return _;
            u = pt.event && d.global, u && 0 === pt.active++ && pt.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Qe.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (Ie.test(o) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = Xe.test(o) ? o.replace(Xe, "$1_=" + Oe++) : o + (Ie.test(o) ? "&" : "?") + "_=" + Oe++)), d.ifModified && (pt.lastModified[o] && _.setRequestHeader("If-Modified-Since", pt.lastModified[o]), pt.etag[o] && _.setRequestHeader("If-None-Match", pt.etag[o])), (d.data && d.hasContent && d.contentType !== !1 || n.contentType) && _.setRequestHeader("Content-Type", d.contentType), _.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Ke + "; q=0.01" : "") : d.accepts["*"]);
            ...
            if (c = V(Je, d, n, _)) {
                if (_.readyState = 1, u && f.trigger("ajaxSend", [_, d]), 2 === b) return _;
        ...
        return ht.reliableHiddenOffsets() ? t.offsetWidth <= 0 && t.offsetHeight <= 0 && !t.getClientRects().length : G(t)
    ...
    pt.param = function (t, e) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var t = this.type;
                return this.name && !pt(this).is(":disabled") && an.test(this.nodeName) && !on.test(t) && (this.checked || !Ft.test(t))
            }).map(function (t, e) {
                var n = pt(this).val();
    ...
    }), ht.cors = !!cn && "withCredentials" in cn, cn = ht.ajax = !!cn, cn && pt.ajaxTransport(function (e) {
                ...
                send: function (i, r) {
                    ...
                    o.send(e.hasContent && e.data || null), n = function (t, i) {
                        ...
                        if (n && (i || 4 === o.readyState))
                            if (delete un[a], n = void 0, o.onreadystatechange = pt.noop, i) 4 !== o.readyState && o.abort();
                            else {
    ...
    pt.ajaxSetup({
        ...
        jsonpCallback: function () {
            var t = hn.pop() || pt.expando + "_" + Oe++;
            return this[t] = !0, t
        }
    }), pt.ajaxPrefilter("json jsonp", function (e, n, i) {
        var r, s, o, a = e.jsonp !== !1 && (dn.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && dn.test(e.data) && "data");
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = pt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(dn, "$1" + r) : e.jsonp !== !1 && (e.url += (Ie.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
            return o || pt.error(r + " was not called"), o[0]
        }, e.dataTypes[0] = "json", s = t[r], t[r] = function () {
            o = arguments
        }, i.always(function () {
            void 0 === s ? pt(t).removeProp(r) : t[r] = s, e[r] && (e.jsonpCallback = n.jsonpCallback, hn.push(r)), o && pt.isFunction(s) && s(o[0]), o = s = void 0
        }), "script"
    ...
    pt.fn.load = function (t, e, n) {
        ...
        var i, r, s, o = this,
            a = t.indexOf(" ");
        return a > -1 && (i = pt.trim(t.slice(a, t.length)), t = t.slice(0, a)), pt.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (r = "POST"), o.length > 0 && pt.ajax({
            url: t,
            type: r || "GET",
            dataType: "html",
            data: e
        ...
        setOffset: function (t, e, n) {
            var i, r, s, o, a, l, u, c = pt.css(t, "position"),
                h = pt(t),
                d = {};
        ...
        offset: function (t) {
            ...
            var e, n, i = {
                ...
                r = this[0],
                s = r && r.ownerDocument;
            if (s) return e = s.documentElement, pt.contains(e, r) ? ("undefined" != typeof r.getBoundingClientRect && (i = r.getBoundingClientRect()), n = et(s), {
        ...
        pt.fn[t] = function (i) {
            return Pt(this, function (t, i, r) {
                var s = et(t);
                return void 0 === r ? s ? e in s ? s[e] : s.document.documentElement[i] : t[i] : void(s ? s.scrollTo(n ? pt(s).scrollLeft() : r, n ? r : pt(s).scrollTop()) : t[i] = r)
            }, t, i, arguments.length, null)
        }
    }), pt.each(["top", "left"], function (t, e) {
        pt.cssHooks[e] = L(ht.pixelPosition, function (t, n) {
        ...
        pt.each({
            ...
            pt.fn[i] = function (i, r) {
                ...
                return Pt(this, function (e, n, i) {
                    var r;
                    return pt.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (r = e.documentElement, Math.max(e.body["scroll" + t], r["scroll" + t], e.body["offset" + t], r["offset" + t], r["client" + t])) : void 0 === i ? pt.css(e, n, o) : pt.style(e, n, i, o)
                }, e, s ? i : void 0, s, null)
            }
        })
    }), pt.fn.extend({
        ...
        prototype: {
            ...
            element: function (e) {
                ...
                return void 0 === s ? delete this.invalid[r.name] : (this.prepareElement(s), this.currentElements = t(s), i = this.groups[s.name], i && t.each(this.groups, function (t, e) {
                    e === i && t !== s.name && (r = o.validationTargetFor(o.clean(o.findByName(t))), r && r.name in o.invalid && (o.currentElements.push(r), a = a && o.check(r)))
            ...
            showLabel: function (e, n) {
                ...
                a.length ? (a.removeClass(this.settings.validClass).addClass(this.settings.errorClass), a.html(n)) : (a = t("<" + this.settings.errorElement + ">").attr("id", l + "-error").addClass(this.settings.errorClass).html(n || ""), i = a, this.settings.wrapper && (i = a.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.length ? this.labelContainer.append(i) : this.settings.errorPlacement ? this.settings.errorPlacement(i, t(e)) : i.insertAfter(e), a.is("label") ? a.attr("for", l) : 0 === a.parents("label[for='" + this.escapeCssMeta(l) + "']").length && (s = a.attr("id"), u ? u.match(new RegExp("\\b" + this.escapeCssMeta(s) + "\\b")) || (u += " " + s) : u = s, t(e).attr("aria-describedby", u), r = this.groups[e.name], r && (o = this, t.each(o.groups, function (e, n) {
